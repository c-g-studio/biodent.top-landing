...
export const AdvantagesList = () => {
  ...
  return <ul
    ...
    <li className={`${itemClass} flex-1 justify-center md:justify-start py-[20px] pr-2.5 md:py-0 md:justify-end`}>
    ...
    <li className={`${itemClass} flex-1 justify-center md:justify-start py-[20px] pr-2.5 md:py-0 xl:flex-[0.5]`}>
      <div className="absolute inset-0 backdrop-blur bg-[rgba(255,255,255,0.4)]"></div>
      <div className="relative z-10 flex flex-col items-center gap-4 md:flex-row">
    ...
    <li className={`${itemClass} flex-1 justify-center md:justify-start py-[20px] pr-2.5 md:py-0`}>
      <div className="absolute inset-0 backdrop-blur bg-[rgba(255,255,255,0.4)]"></div>
      <div className="relative z-10 flex flex-col items-center gap-4 md:flex-row">
