...
export const metadata = {
  ...
  description:
    ...
    'Номер нашої стоматологічної клініки - 380980389278',
  keywords:
...
export default function Page() {
  return (
    <Section>
      ...
      <Typography
        variant="h2"
        className="mb-1 text-[16px] text-blue-extra-dark md:text-[18px] lg:text-[20px]"
      >
      ...
      <Typography variant="p" className="mb-3 text-blue-extra-dark">
        ...
        Оновлення буде опубліковано на цій сторінці.
      </Typography>
      ...
      <Typography variant="p" className="mb-3 text-blue-extra-dark">
        ...
        <Link
          ...
          target="_blank"
        >
          <span className="font-arial text-blue transition-all hover:text-blue">
            098-038-92-78
          </span>
        </Link>
      </Typography>
