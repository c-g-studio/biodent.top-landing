  ...
  return (
    <Section>
      ...
      <Typography variant={'p'} className={'mb-3 text-blue-extra-dark'}>
        ...
        телефону (запитується через форму на сайті); Ім'я (якщо користувач надає
        його добровільно); Інші дані, які користувач може вказати в заявці або
        повідомленні. Ця інформація використовується виключно для зв’язку з
        клієнтом, надання консультацій та запису на прийом.
      </Typography>
      <Typography
        variant={'h2'}
        className={
